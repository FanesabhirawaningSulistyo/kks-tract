...
<head>
    ...
    <title>KKSTrack - Halaman Lupa Password</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ route('dashboard') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">KKS-Track</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        
                        <h4 class="mb-2">Lupa Password?</h4>
                        <p class="mb-4">Masukkan email anda dan kami akan mengirimkan instruksi untuk mengatur ulang password</p>
